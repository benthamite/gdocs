...
The development repository is on [[https://github.com/benthamite/gdocs][GitHub]].
...
progress.  The indicator tracks actual Google HTTP requests, not the
OAuth authorization prompt, and disappears when all pending requests
complete.
